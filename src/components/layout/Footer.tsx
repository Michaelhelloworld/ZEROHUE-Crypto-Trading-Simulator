...
const Footer: React.FC = () => {
  return (
    <footer className="w-full py-8 mt-auto border-t border-white/5 bg-[#0f172a]/20 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-center md:text-left">
          <p className="text-sm font-bold text-slate-400">
            &copy; {new Date().getFullYear()} ZEROHUE. All rights reserved.
          </p>
          <p className="text-[10px] text-slate-600 mt-1 font-medium">Crypto Trading Simulator</p>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 text-slate-400 hover:text-[#5865F2] transition-colors"
            aria-label="Join our Discord"
          >
            <div className="p-2 rounded-lg bg-white/5 group-hover:bg-[#5865F2]/20 group-hover:border-[#5865F2]/30 transition-colors border border-white/5">
              {/* Discord Logo SVG */}
              <svg viewBox="0 0 24 24" aria-hidden="true" className="h-4 w-4 fill-current">

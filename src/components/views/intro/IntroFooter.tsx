...
import { introPrimaryCtaLabel, legalLinks, resourceLinks, socialLinks } from './content';
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-8 flex flex-col gap-8 border-t border-white/8 pt-8 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-xs">
            ...
            <p className="mt-4 text-sm leading-6 text-slate-400">
              Local-first crypto trading simulator for paper practice.
            </p>
          </div>

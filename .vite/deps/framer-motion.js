...
function supportsBrowserAnimation(options) {
  ...
  const subject =
    (_a = motionValue2 == null ? void 0 : motionValue2.owner) == null ? void 0 : _a.current;
...
var AsyncMotionValueAnimation = class extends WithPromise {
  ...
  onKeyframesResolved(keyframes2, finalKeyframe, options, sync2) {
    ...
    const element =
      (_b = (_a = resolvedOptions.motionValue) == null ? void 0 : _a.owner) == null
        ? void 0
        : _b.current;
...
var NodeStack = class {
  ...
  add(node) {
    ...
    for (let i = this.members.length - 1; i >= 0; i--) {
      ...
      if (m2 === node || m2 === this.lead || m2 === this.prevLead) continue;
...
function PopChild({ children, isPresent: isPresent2, anchorX, anchorY, root, pop }) {
  ...
  const childRef =
    ((_a = children.props) == null ? void 0 : _a.ref) ?? (children == null ? void 0 : children.ref);
  ...
  return (0, import_jsx_runtime.jsx)(PopChildMeasure, {
    ...
    sizeRef: size,
    pop,
    children: pop === false ? children : React2.cloneElement(children, { ref: composedRef }),
  });
}

'use client';
import { require_react } from './chunk-SKCSXP5W.js';
...
var o = (e2, t2) => {
  ...
  for (let n3 in e2) {
    ...
    '@' == n3[0]
      ? 'i' == n3[1]
        ? (r = n3 + ' ' + c2 + ';')
        : (l2 += 'f' == n3[1] ? o(c2, n3) : n3 + '{' + o(c2, 'k' == n3[1] ? '' : t2) + '}')
      : 'object' == typeof c2
        ? (l2 += o(
            c2,
            t2
        ...
        : null != c2 &&
          ((n3 = /^--/.test(n3) ? n3 : n3.replace(/[A-Z]/g, '-$&').toLowerCase()),
        ...
        : ((e3) => {
            ...
            for (; (t4 = l.exec(e3.replace(a, ''))); )
              t4[4]
                ? o2.shift()
                : t4[3]
                  ? ((r2 = t4[3].replace(n, ' ').trim()), o2.unshift((o2[0][r2] = o2[0][r2] || {})))
  ...
  return i(
    l2.unshift
      ? l2.raw
        ...
        : l2.reduce((e3, t2) => Object.assign(e3, t2 && t2.call ? t2(r.p) : t2), {})
      : l2,
    t(r.target),
    r.g,
    r.o,
...
var H = (e2, t2) => {
  ...
  switch (t2.type) {
    ...
    case 1:
      return {
        ...e2,
        toasts: e2.toasts.map((r) => (r.id === t2.toast.id ? { ...r, ...t2.toast } : r)),
      };
    case 2:
      let { toast: s2 } = t2;
    ...
    case 3:
      ...
      return {
        ...
        toasts: e2.toasts.map((r) =>
          r.id === a2 || a2 === void 0 ? { ...r, dismissed: true, visible: false } : r
        ),
      };
    case 4:
    ...
    case 6:
      ...
      return {
        ...e2,
        pausedAt: void 0,
        toasts: e2.toasts.map((r) => ({ ...r, pauseDuration: r.pauseDuration + i2 })),
      };
  }
};
var v = [];
  ...
  let i2 = o2.toasts.map((r) => {
    ...
    return {
      ...
      duration:
        ...
        se[r.type],
      style: { ...e2.style, ...((T = e2[r.type]) == null ? void 0 : T.style), ...r.style },
    };
  });
  return { ...o2, toasts: i2 };
};
  ...
  return (
    ...
    e2
      .then((a2) => {
        ...
        return (
          i2
            ? n2.success(i2, { id: s2, ...o2, ...(o2 == null ? void 0 : o2.success) })
            : n2.dismiss(s2),
          a2
        );
      })
...
var w2 = (e2, t2 = 'default') => {
  ...
  let r = (0, import_react2.useCallback)(S(t2), [t2]),
    ...
    d2 = (0, import_react2.useCallback)(
      (c2, m2) => {
        let { reverseOrder: p2 = false, gutter: R = 8, defaultPosition: z } = m2 || {},
          O = o2.filter((u2) => (u2.position || z) === (c2.position || z) && u2.height),
  ...
  return (
    ...
    { toasts: o2, handlers: { updateHeight: g2, startPause: l2, endPause: T, calculateOffset: d2 } }
  );
};
var de = h`
from {
      ...
      : b2.createElement(
          ...
          o2 !== 'loading' &&
            b2.createElement(
              be,
              null,
              o2 === 'error' ? b2.createElement(C, { ...s2 }) : b2.createElement(L, { ...s2 })
            )
        );
};
var Re = (e2) => `
...
var N = y.memo(({ toast: e2, position: t2, style: o2, children: s2 }) => {
  let a2 = e2.height ? ke(e2.position || t2 || 'top-center', e2.visible) : { opacity: 0 },
  ...
  return x.createElement(
    ...
    g2.map((d2) => {
      let c2 = d2.position || t2,
        m2 = T.calculateOffset(d2, { reverseOrder: e2, gutter: s2, defaultPosition: t2 }),
        p2 = Me(c2, m2);
      return x.createElement(
        we,
        {
